...
test:
	...
	@echo "=== E2E Tests ==="
	@go test -v -race -coverprofile=$(COVERAGE_DIR)/e2e.out -covermode=atomic -coverpkg=github.com/wkoszek/s3pico/pkg/s3pico ./tests/e2e/...
	@echo ""
	@echo "=== AWS CLI Tests ==="
	@go test -v -race -coverprofile=$(COVERAGE_DIR)/awscli.out -covermode=atomic -coverpkg=github.com/wkoszek/s3pico/pkg/s3pico ./tests/awscli/...
	@echo ""
